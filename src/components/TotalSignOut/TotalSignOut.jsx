...
export class TotalSignOut extends Component {
  ...
  render() {
    return (
        <div className="col-md-2" id="signOutStat">
          <h4>Total User Sign Out per Week <i className="fas fa-user-times fa-sm"></i></h4>
          <p id="sign"><CountUp
              className="counter"
              start={10}
              end={99}
